    ...
    %>
        ...
        <section class="container">
        	...
        	<div class="card-header bg-light">
        		<div class="row">
        			<div class="col-8 text-left">컴퓨터구조&nbsp;<small>권혁윤</small></div>
        			<div class="col-4 text-right">
        				...
        				<div class="card-body">
        				<h5 class="card-title">
        				훌륭한 강의.&nbsp;<small>(2019년 학기)</small>
        				</h5>
        				<p class="card-text">널널한 강의 꿀강의
        				<div class="row">
        					<div class="col-9 text-left">
        						성적<span style="color: red;">A</span>
        						인성<span style="color: red;">A</span>
        	...
        	<div class="card-header bg-light">
        		<div class="row">
        			<div class="col-8 text-left">운영체제&nbsp;<small>권혁윤</small></div>
        			<div class="col-4 text-right">
        				...
        				<div class="card-body">
        				<h5 class="card-title">
        				지루한 강의.&nbsp;<small>(2019년 학기)</small>
        				</h5>
        				<p class="card-text">지루해요 노잼
        				<div class="row">
        					<div class="col-9 text-left">
        						성적<span style="color: red;">C</span>
        						인성<span style="color: red;">B</span>
        	...
        	<div class="card-header bg-light">
        		<div class="row">
        			<div class="col-8 text-left">자료구조&nbsp;<small>권혁윤</small></div>
        			<div class="col-4 text-right">
        				...
        				<div class="card-body">
        				<h5 class="card-title">
        				성적은 잘줌.&nbsp;<small>(2019년 학기)</small>
        				</h5>
        				<p class="card-text"> 어렵지만 성적은 잘줌
        				<div class="row">
        					<div class="col-9 text-left">
        						성적<span style="color: red;">A</span>
        						인성<span style="color: red;">A</span>
